...
public class Piece implements Serializable {
    ...
    private void setPieceImage() {
        if (this.color == PieceColor.RED) {
            switch (type) {
                case SCOUT:
                    this.spriteKey = "RED_02";
                    break;
                case MINER:
                    this.spriteKey = "RED_03";
                    break;
                case SERGEANT:
                    this.spriteKey = "RED_04";
                    break;
                case LIEUTENANT:
                    this.spriteKey = "RED_05";
                    break;
                case CAPTAIN:
                    this.spriteKey = "RED_06";
                    break;
                case MAJOR:
                    this.spriteKey = "RED_07";
                    break;
                case COLONEL:
                    this.spriteKey = "RED_08";
                    break;
                case GENERAL:
                    this.spriteKey = "RED_09";
                    break;
                case MARSHAL:
                    this.spriteKey = "RED_10";
                    break;
                case BOMB:
                    this.spriteKey = "RED_BOMB";
                    break;
                case FLAG:
                    this.spriteKey = "RED_FLAG";
                    break;
                case SPY:
                    this.spriteKey = "RED_SPY";
                    break;
                default:
                    break;
            }
            ...
            switch (type) {
                case SCOUT:
                    this.spriteKey = "BLUE_02";
                    break;
                case MINER:
                    this.spriteKey = "BLUE_03";
                    break;
                case SERGEANT:
                    this.spriteKey = "BLUE_04";
                    break;
                case LIEUTENANT:
                    this.spriteKey = "BLUE_05";
                    break;
                case CAPTAIN:
                    this.spriteKey = "BLUE_06";
                    break;
                case MAJOR:
                    this.spriteKey = "BLUE_07";
                    break;
                case COLONEL:
                    this.spriteKey = "BLUE_08";
                    break;
                case GENERAL:
                    this.spriteKey = "BLUE_09";
                    break;
                case MARSHAL:
                    this.spriteKey = "BLUE_10";
                    break;
                case BOMB:
                    this.spriteKey = "BLUE_BOMB";
                    break;
                case FLAG:
                    this.spriteKey = "BLUE_FLAG";
                    break;
                case SPY:
                    this.spriteKey = "BLUE_SPY";
                    break;
                default:
                    break;
            }
