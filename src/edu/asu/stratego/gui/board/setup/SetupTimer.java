...
public class SetupTimer {
    ...
    private IntegerProperty secondsLeft = new SimpleIntegerProperty(START_TIME);
    ...
    private class StartTimer implements Runnable {
        ...
        public void run() {
            ...
            timeline.getKeyFrames().add(new KeyFrame(Duration.seconds(START_TIME + 1), new KeyValue(secondsLeft, 0)));
